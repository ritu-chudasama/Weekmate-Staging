	...
	render() {
		...
		return (
			<InspectorControls key="inspector">
				<RenderSettingControl id="gb_column_inner_marginPadding">
					<PanelBody
				...
				<RenderSettingControl id="gb_column_inner_colorSettings">
					<PanelColorSettings
				...
				<RenderSettingControl id="gb_column_inner_backgroundImagePanel">
