...
Integrations with popular plugins like WooCommerce, BuddyPress, MailChimp, Paid Memberships Pro, Ultimate Member, and applications like Discord & Hubspot.
 ...
 | <a href="https://plugins.miniorange.com/setup-wordpress-social-login-plugin" target="_blank"> Setup </a>|<a href="https://www.youtube.com/watch?v=ln17jan6t1Y" target="_blank"> Videos </a>|<a href="https://plugins.miniorange.com/social-login-social-sharing" target="_blank"> Docs </a>|<a href="https://plugins.miniorange.com/social-login-social-sharing#addon" target="_blank"> Pro Addon </a>
...
*   <a href="https://plugins.miniorange.com/configure-hubspot-sign-in-for-wordpress-website" target="_blank">HubSpot login</a>
...
*   <a href=" https://plugins.miniorange.com/integrate-github-login-in-your-website-wordpress-oauth" target="_blank">Github login</a>  
...
*   <a href="https://plugins.miniorange.com/how-to-setup-steam-login-for-wordpress-website-social-login" target="_blank">Steam login</a>
...
*   **With Applications** - 
*   <a href="https://plugins.miniorange.com/discord-wordpress-add-on" target="_blank">Discord social login integration</a> 
*   <a href="https://plugins.miniorange.com/hubspot-integration-wordpress-social-login" target="_blank">Hubspot social login integration</a> 
...
*   Take full control - Setup your social login application with APP ID and APP Secret for Facebook, Google, Twitter, Vkontakte, LinkedIn, Amazon, Windows Live & Yahoo.
...
= Once Activated =
1. Go to `Social Login, Social Sharing by miniOrange` from the side menu and select your Social Login and Social Share apps.
...
In that case, your website needs to be publicly hosted for Facebook social share.
...
* Added LinkedIn OIDC Application.
* Added Error Codes.
* Fixed the custom registration add-on role update issue.
...
= 7.6.3 =
* Fixed the WordPress premium app issue.

= 7.6.2 =
* Google button error fixed on customise icons tab.
* Fixed the issue of premium integrations tab.
...
* Added Trello, Steam, and Gitlab in Premium versions.
* minor UI changes.
...
* Resolved UI issues for Github, Apple, Amazon, Disqus, and Yandex social network providers 
...
= 7.4.5 =
* Updated Google SVG and resolved conflicts on the login with the Google button.
* Added notice for Facebook Data Check-up for Social login. If the data use checkup is not completed Facebook Social Login App will stop working.
...
= 7.4.2 =
* Resolved JS and CSS issues of social login icons with BuddyBoss and LearnPress plugins.
...
= 7.4.1 =
* Updated jQuery deprecated functions in the base code of social login.
* Minor UI changes to various social login icon elements.
* Added MemberPress display options in the premium version.
* Added Social Login Applications like GitHub, HubSpot, mail.ru in the premium version.
...
* Added Meetup attributes in the premium plugin.
...
= 6.2.5 =
*   Fix in the flow of Registration in the plugin (OTP not validated)
*   Fix in sending email to admin
*   Added Kakao login (카카오 로그인)

= 6.2.4 =
*   Fix in the flow of Registration in the plugin (OTP not received)
*   Fixed minor warnings
*   Fix for issue in redirect to the same page
...
= 5.2.2 =
*  Added WhatsApp share for the Desktop site
...
= 4.9.2 =
*  Added Social Sharing support for bbPress forumsURLBugfix, topics, replies
...
= 4.8.5 =
*  Added Login in registration page and Register in the login page for in-plugin authentication
...
= 4.4.1 =
*  Additional option of validating account using the a phone number
...
= 3.0.4 =
* Bugfix for Social Login and Social Sharing.
...
= 2.0 =
* bug fixes and changes for Social Login in the user email verification.
...
= 7.4.2 =
* Resolved JS and CSS issues with Buddyboss and LearnPress plugins.
...
= 7.3.8 =
* Updated Odnoklassniki custom app fix in premium versions.
* Updated BuddyPress mapping bug fix in the premium version.
* Updated deprecated array and string fix.
* Added Yandex app in premium applications.
...
= 7.2.4 =
* Made contact us changes.
* Storing the first name and lastname issue solved.
* Changed datatype of column user_id in the mo_openid_linked_user table.
* Added end tour button.
...
= 7.1.1 =
* Fixed "the plugin generated 2 characters of unexpected output during activation"
* Fixed issue of tour restarting every time for Firefox
...
= 6.6.9 =
* Fixed GDPR related bug.
* Update guide for the Facebook custom app.
* Fixed facebook related issue.
* Fixed some warnings.
*   Updated UI for social login icons
...
= 6.6.1 =
*   Fix for issue in editing/uploading BuddyPress profile picture
*   Added check to prohibit insertion of rows in account linking table that has empty field values
*   Removed rows in account linking table that have empty field values
...
= 6.4.0 =
*   Fix for a Facebook registration issue
...
= 6.2.6 =
*   Fix for bug in the auto-scroll  script
*   Handled non-English characters in post URL
...
*   Fix in the flow of Registration in the plugin (OTP not received)
*   Fixed minor warnings
*   Fix for issue in a redirect to the same page
...
= 5.2.2 =
*  Added WhatsApp share for the BugfixDesktop site
...
= 4.9.2 =
*  Added Social Sharing support for bbPress forums, topics, replies
*  Fix for role mapping
*  Fix for json_last_error error in previous PHP versions
*  Enhancement in forgot password
...
= 4.8.3 =
*  Added option to hide Vertical Floating icons on mobile
*  Added option to customize edge of a long button - Social Login
*  Added extra options for licensing
*  Fix - Redirecting from Social Login gives "restricted due to security rule" error
...
= 4.4.1 =
*  Additional option of validating account using a phone number
